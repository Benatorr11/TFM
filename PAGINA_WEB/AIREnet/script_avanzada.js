...
document.getElementById('ODE').addEventListener('click', function() {
    window.location.href = './ode_p.html'; // Redirige al usuario a avanzada.html
});

/* Función para cambiar a la página del modo avanzado */ 
document.getElementById('MODELOS').addEventListener('click', function() {
    window.location.href = './modelos.html'; // Redirige al usuario a avanzada.html
});
